...
namespace TextRPG
{
    ...
    public class Warrior : ICharacter
    {
        ...
        public int Attack => new Random().Next(10, AttackPower); // 최소 범위 ~ 초기 공격력 사이 랜덤
    ...
    public class Monster : ICharacter
    {
        ...
        public bool IsDead => Health <= 0;
        public int Attack => new Random().Next(10, 20); // 최소 범위 ~ 최대 범위 사이 랜덤
    ...
    {
        string Name { get; }
        void Use(Warrior warrior); // 전사 아이템 사용 메서드
    }
